  ...
  return (
    <div className="px-4 sm:px-[5%] border-b border-gray-100">
      <div className="max-w-screen-xl mx-auto py-6 sm:py-8 flex justify-between items-center gap-5 w-full">
        <h1 className="text-xl sm:text-2xl font-semibold text-midnight-navy">About</h1>
        <Breadcrumb>
          <BreadcrumbList>
            <BreadcrumbItem>
              <BreadcrumbLink
            ...
            <BreadcrumbItem>
              <BreadcrumbPage className="text-sm font-medium text-midnight-navy">About</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
