...
import { useHandleAddCategoryMutation } from "@/redux/features/categories/categoriesApi";
...
const AddPage = () => {
  ...
  const [handleAddCategory, { isLoading }] = useHandleAddCategoryMutation();
  ...
  const onSubmit: SubmitHandler<IFormInput> = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        categoryPhoto: imageURLs[0],
      };

      await handleAddCategory(payload).unwrap();
  ...
  return (
    <div>
      <Heading
        title="Add Category"
        subTitle="Fill in the details to add a new member to your category."
      />
      <FormProvider {...methods}>
        ...
        >
          ...
          >
            {isLoading || isImageUploading ? "Please Wait..." : "Add Category"}
          </Button>
